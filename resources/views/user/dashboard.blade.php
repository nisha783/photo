...
<body>
  <div class="hero">
    <nav class="bg-dark">
      ...
      <ul class="mt-3">
        <li class="ps-4 "><a href="{{route('user.dashboard')}}"  class="text-decoration-none" style="color:#fff;">Home</a></li>
        <li class="ps-4 "><a href="{{route('photo.create')}}"  class="text-decoration-none" style="color:#fff;">Create</a></li>
        <li class="ps-4 "><a href="#"  class="text-decoration-none" style="color:#fff;">Profile</a></li>
      </ul>
...
<div class="container-fluid mt-3">
    <div class="photo-grid">
      ...
      <div class="grid-item">
        <img src="{{ asset($photo->filepath) }}" alt="{{ $photo->title }}" class="img-fluid" style="width: 100%; object-fit: cover;">
      </div>
      @endforeach
    </div>
</div>
