...
function initGradientLine() {
  var e = {
    ...
    xaxis: {
      ...
      tickAmount: 10,
      labels: {
        formatter: function formatter(e, t, a) {
  ...
  new ApexCharts(document.querySelector("#gradientLine"), e).render();
}
function initLineDataLabels() {
  new ApexCharts(document.querySelector("#lineDataLabels"), {
    series: [{
      name: "High - 2023",
...
function initBasicBar() {
  var _ApexCharts;
  new ApexCharts(document.querySelector("#basicBar"), (_ApexCharts = {
    chart: {
      height: 350,
      type: "bar",
      foreColor: "#6c757d",
  ...
  }, _defineProperty(_ApexCharts, "dataLabels", {
    enabled: !1
  }), _defineProperty(_ApexCharts, "colors", ["#e5e7eb", "#3E97FF", "#e49e3d"]), _defineProperty(_ApexCharts, "series", [{
    name: "Revenue",
  ...
  }]), _defineProperty(_ApexCharts, "xaxis", {
  ...
  }), _defineProperty(_ApexCharts, "yaxis", {
    labels: {
      formatter: function formatter(e) {
        return +e + " K";
      },
  ...
  }), _defineProperty(_ApexCharts, "grid", {
    show: !1
  }), _defineProperty(_ApexCharts, "tooltip", {
    theme: "dark",
    y: {
      formatter: function formatter(e) {
        return +e + " K";
  ...
  }), _defineProperty(_ApexCharts, "legend", {
    show: !1
  }), _ApexCharts)).render();
}
function initColumnDataLabels() {
  new ApexCharts(document.querySelector("#columnDataLabels"), {
    series: [{
      name: "Expenses",
...
function initStackedColumns() {
  new ApexCharts(document.querySelector("#stackedColumns"), {
    chart: {
      type: "bar",
      height: 350,
      stacked: !0,
...
function initBasicArea() {
  new ApexCharts(document.querySelector("#basicArea"), {
    chart: {
      height: 365,
      type: "area",
      foreColor: "#6c757d",
...
function initBarLine() {
  new ApexCharts(document.querySelector("#barLine"), {
    chart: {
      height: 380,
      width: "100%",
      foreColor: "#6c757d",
...
function initCandlestickCharts() {
  ...
  new ApexCharts(document.querySelector("#candlestickCharts"), e).render();
}
function initSimplePie() {
  new ApexCharts(document.querySelector("#simplePie"), {
...
function initGradientDonut() {
  new ApexCharts(document.querySelector("#gradientDonut"), {
    series: [44, 55, 41, 17, 15],
    colors: ["#00275E", "#85D00B", "#007BFF", "#00CCCC", "#6610F2"],
    labels: ["Sumi", "Swapan", "Sojib", "Swampa", "Sowrav"],
    chart: {
...
function initBasicRadar() {
  new ApexCharts(document.querySelector("#basicRadar"), {
    chart: {
      height: 350,
      type: "radar",
      foreColor: "#6c757d",
...
function initRadarMultiple() {
  new ApexCharts(document.querySelector("#radarMultiple"), {
    series: [{
      name: "Revenue",
...
function initRadarPolygon() {
  new ApexCharts(document.querySelector("#radarPolygon"), {
    series: [{
      name: "Radar Polygon",
...
initGradientLine(), initLineDataLabels(), initBasicBar(), initColumnDataLabels(), initStackedColumns(), initBasicArea(), initBarLine(), initCandlestickCharts(), initSimplePie(), initSimpleDonut(), initGradientDonut(), initBasicRadar(), initRadarMultiple(), initRadarPolygon();